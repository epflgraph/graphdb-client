...
class EnvironmentGateway:
    ...
    def database_exists(self, schema_name: str) -> bool:
        return self._database.database_exists(schema_name)

    def create_database(self, schema_name: str, drop_existing: bool = False) -> None:
        self._database.create_database(schema_name, drop_existing=drop_existing)

    def drop_database(self, schema_name: str) -> None:
        self._database.drop_database(schema_name)
    ...
    def drop_table(self, schema_name: str, table_name: str) -> None:
        self._table.drop_table(schema_name, table_name)
    ...
    def get_create_view(self, schema_name: str, view_name: str) -> str:
        return self._view.get_create_view(schema_name, view_name)

    def is_view(self, schema_name: str, name: str) -> bool:
        return self._view.is_view(schema_name, name)
    ...
    # Composite entity descriptions
    def describe_table(self, schema_name: str, table_name: str) -> Table:
        create_sql = self._table.get_create_table(schema_name, table_name)
        columns = self._column.get_columns(schema_name, table_name)
        keys = self._key.get_key_entities(schema_name, table_name)
    ...
    def describe_view(self, schema_name: str, view_name: str) -> View:
        create_sql = self._view.get_create_view(schema_name, view_name)
